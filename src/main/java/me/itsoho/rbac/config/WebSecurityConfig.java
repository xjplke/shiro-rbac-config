...
import me.itsoho.shiro.cluster.cache.CustomShiroCacheManager;
import me.itsoho.shiro.cluster.cache.JedisShiroCacheManager;
...
public class WebSecurityConfig  {
	...
	@Bean
	@Autowired
	public DefaultWebSecurityManager securityManager(DataSource dataSource,AuthorizingRealm userRealm,JedisManager jedisManager){
	//public DefaultWebSecurityManager securityManager(DataSource dataSource,UserRealm userRealm,RedisManager redisManager){
